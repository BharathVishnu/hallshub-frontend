  ...
  return (
    <div className="flex relative items-center justify-center mt-70 md:mt-80">
      <div className="absolute right-1 bg-[#3D51BE] rounded-l-3xl px-6 py-12 md:px-96 shadow-2xl w-full md:w-[1321px] flex flex-col gap-2"  style={gradientStyle}>
        ...
        {/* Login Button */}
        <Link href="/" className="mt-5 md:ml-32 mx-auto md:w-[272px] text-md text-center opacity-[80%] bg-[#6B739D] hover:text-black hover:font-bold hover:bg-white text-white rounded-full py-3 px-8 shadow-md hover:shadow-2xl hover:shadow-black transition duration-500">
          Register
        </Link>
